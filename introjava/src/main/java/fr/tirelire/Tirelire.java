...
public class Tirelire {
  ...
  public void vider() {
    montant = 0; // La propriété montant passe à 0
  }
  ...
  public String getCaractéristiques() {
    ...
    } // Formater une String (La mettre en forme)
    // On peut pas mélanger les types , le String format permet de tout convertir et de les mettre en format 
